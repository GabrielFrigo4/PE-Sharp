...
unsafe public class PE32PlusFile: AbstractPEFile
{
    ...
    public PE32PlusFile(byte[] bytes, GCHandle pin, byte* p, CoffHeader* coffHeader)
        : base(bytes, pin, p, coffHeader)
    {
        PEFileType = PEFileType.PE32Plus;

        // Get the standard header
        PtrStandardHeader = (OptionalHeaderStandardPlus*)(CoffHeader + 1);
        ...
        PtrWindowsHeader = (OptionalHeaderWindowsPlus*)(PtrStandardHeader + 1);
    ...
    /// </summary>
    public OptionalHeaderWindowsPlus* PtrWindowsHeader { get; private set; }
